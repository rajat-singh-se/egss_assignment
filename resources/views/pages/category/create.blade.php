...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header d-flex justify-content-between"><div><strong> {{ __('Create Blog Category') }}</strong></div> <div>
                ...
                <div class="card-body">
                    <form action="{{route('category.save')}}" method="POST" enctype="multipart/form-data" >
                        ...
                        <div class="form-group">
                          ...
                          <input required type="text" class="form-control" name="category_name" aria-describedby="Category" placeholder="Enter Category Name">
